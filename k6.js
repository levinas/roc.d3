...
queue()
    .defer(d3.tsv, "results/AN.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/CIP.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/FOSFO.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/FOX.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/GM.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/IPM.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/LVX.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/MEM.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/NN.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/TE.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/TIG.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/TZP.k6.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .awaitAll(ready);
...
svg.append("text").attr("x", width/2).attr("y", -20).style("text-anchor", "middle").style("font-size", "22px").text("ROC Curves (Klebsiella, k=6, Random Forest)");
