...
queue()
    .defer(d3.tsv, "results/AN.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/CIP.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/FOSFO.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/FOX.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/GM.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/IPM.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/LVX.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/MEM.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/NN.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/TE.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/TIG.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .defer(d3.tsv, "results/TZP.k3.RF.ROC", function(d) { return { x:+d.FPR, y:+d.TPR }; } )
    .awaitAll(ready);
...
svg.append("text").attr("x", width/2).attr("y", -20).style("text-anchor", "middle").style("font-size", "22px").text("ROC Curves (Klebsiella, k=3, Random Forest)");
